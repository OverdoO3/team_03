...
public:
	...
	//}
    //回転バージョン
	static void ScoreRenderDigit(RenderContext rc, Sprite* sprite, int score,
	...
	static void ScoreRenderDigit_NoHead_Spacing(RenderContext rc, Sprite* sprite, int score,
		float texSizeX, float texSizeY, float worldPosX, float worldPosY,
